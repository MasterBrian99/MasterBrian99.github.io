...
export function Footer({ brand, tagline, columns = [], note,className }: FooterProps) {
  return (
    <footer className={cx('pouf-footer bg-surface rounded-card cushion-card px-(--s7) pt-(--s7) pb-(--s6)',className)}>
